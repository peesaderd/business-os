class VoicePOS {
  constructor() {
    ...
    this.pendingItems = []; // items waiting for popup confirmation
  ...
  speak(text) {
    ...
    // Clean text: keep Thai chars, English, numbers, common punctuation & spaces
    // Remove emojis and special symbols that break TTS
